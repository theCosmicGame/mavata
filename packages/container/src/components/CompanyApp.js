  ...
  useEffect(() => {
    ...
    const { onParentNavigate } = mount(ref.current, {
      ...
      onNavigate: ({ pathname: nextPathname }) => {
        console.log('The container noticed navigation inside Company ..');
        console.log('CompanyApp: next path was ' + nextPathname);    // need synchronization to update current path inside of container
